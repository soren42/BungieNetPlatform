...
* **URI:** [[/Forum/GetCoreTopicsPaged/{page}/{sort}/{quickDate}/{categoryFilter}/|https://www.bungie.net/Platform/Forum/GetCoreTopicsPaged/{page}/{sort}/{quickDate}/{categoryFilter}/]]
...
---- | ------ | -------- | -----------
categoryFilter | [[ForumTopicsCategoryFiltersEnum|Forum-ForumTopicsCategoryFiltersEnum]]:Enum | Yes | The category filter.
page | integer:int32 | Yes | Zero base page
quickDate | [[ForumTopicsQuickDateEnum|Forum-ForumTopicsQuickDateEnum]]:Enum | Yes | The date filter.
sort | [[ForumTopicsSortEnum|Forum-ForumTopicsSortEnum]]:Enum | Yes | The sort mode.
...
## Example
### Request
GET https://www.bungie.net/Platform/Forum/GetCoreTopicsPaged/{page}/{sort}/{quickDate}/{categoryFilter}/
...
## References
1. https://bungie-net.github.io/multi/operation_get_Forum-GetCoreTopicsPaged.html#operation_get_Forum-GetCoreTopicsPaged
