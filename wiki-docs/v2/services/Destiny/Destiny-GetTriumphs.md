...
* **URI:** [[/Destiny/{membershipType}/Account/{destinyMembershipId}/Triumphs/|https://bungie.net/d1/Platform/Destiny/{membershipType}/Account/{destinyMembershipId}/Triumphs/]]
...
## Example
### Request
GET https://bungie.net/d1/Platform/Destiny/{membershipType}/Account/{destinyMembershipId}/Triumphs/

### Response
PlatformErrorCode: 200
```javascript
{
    // Type: [#/components/schemas/Destiny.GetTriumphs]
    "Response": null,
