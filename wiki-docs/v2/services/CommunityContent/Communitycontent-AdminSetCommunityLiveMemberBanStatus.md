...
## Example
### Request
POST https://www.bungie.net/Platform/CommunityContent/Live/Partnerships/{param1}/{param2}/Ban/{param3}/
```javascript
{
    // Type: object
}
...
```javascript
{
    // Type: [#/components/schemas/CommunityContent.AdminSetCommunityLiveMemberBanStatus]
    "Response": null,
