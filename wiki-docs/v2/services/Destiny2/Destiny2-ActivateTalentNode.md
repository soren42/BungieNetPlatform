...
* **URI:** [[/Destiny2/Actions/Items/ActivateTalentNode/|https://www.bungie.net/Platform/Destiny2/Actions/Items/ActivateTalentNode/]]
...
## Example
### Request
POST https://www.bungie.net/Platform/Destiny2/Actions/Items/ActivateTalentNode/
```javascript
{
    // Type: integer:int64
    "itemId": 0,
