...
Spasm.RenderMesh.prototype.getUniformDatas = function(n, t) {
	var positionScale = this.positionScale,
		...
		y = new Spasm.UniformData(v, new Float32Array(positionScale)),
		p = new Spasm.ShaderInput(i.uniform, r.vec3, "u_position_offset"),
		w = new Spasm.UniformData(p, new Float32Array(positionOffset)),
		b = new Spasm.ShaderInput(i.uniform, r.vec2, "u_texcoord_scale"),
		k = new Spasm.UniformData(b, new Float32Array(textureScale)),
